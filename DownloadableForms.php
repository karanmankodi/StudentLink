...
<link href="./Styles/CSS/DownloadableForms.css" rel="stylesheet">
...
<!-- Links -->
<div class="row content-below-menu">
</div>
<div class="row">
<div class="col-lg-2 col-md-2 col-sm-2" id="links">
	<div class="row">
    	<ul class="nav" id="basics-menu-list">
        	<li> <a id="adddrop" class="btn"> Add/Drop Form </a> </li>
            <li> <a id="clear" class="btn"> Clear </a> </li>
            
        </ul>
    </div>
</div>
<div class="col-lg-10 col-md-10 col-sm-10" id="forms">
</div>
</div>
<!-- Links ends -->
